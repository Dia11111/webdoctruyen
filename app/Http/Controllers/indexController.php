...
class indexController extends Controller
{
    ...
    {
        $danhmuc = DanhmucTruyen::rderBy('id', 'DESC')->get();
        $truyen = Truyen::rderBy('id', 'DESC')->where('kichhoat', 0)->get();
    ...
    public function danhmuc($slug)
    {
        ...
        $truyen = Truyen::rderBy('id', 'DESC')->where('kichhoat', 0)->where('danhmuc_id', $danhmuc_id->id)->get();
